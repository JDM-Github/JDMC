...
public:
    static void DrawBoxHollow(Window *window, int width, int height, float x, float y, int thickness, wchar_t Character = S1, short color = (FG_LWHITE | BG_BLACK), bool AlphaR = 0)
    {
    ...
    static void DrawCircle(Window *window, float x, float y, int radius, wchar_t Character = S1, short color = (FG_LWHITE | BG_BLACK), bool AlphaR = 0)
    {
